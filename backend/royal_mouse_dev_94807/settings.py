"""
Django settings for royal_mouse_dev_94807 project.
...
ROOT_URLCONF = 'royal_mouse_dev_94807.urls'
...
WSGI_APPLICATION = 'royal_mouse_dev_94807.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "royal_mouse_dev_94807 API",
    "DESCRIPTION": "API documentation for royal_mouse_dev_94807 App",
    "VERSION": "v1",
}
